...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if percentage_value >= 80.0:
        return "green"
    if percentage_value < 80.0 and percentage_value >= 60.0:
        return "orange"
    if percentage_value < 60.0 and percentage_value >= 30.0:
        return "red"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if (temperature * neutrons_produced_per_second >= 0.9 * threshold) and (temperature * neutrons_produced_per_second <= 1.10 * threshold):
        return "NORMAL"
